...
import 'package:appdidtask/controller/RandommealController.dart';
...
class _RandomMealState extends State<RandomMeal> {
  final Randommealcontroller foodDetailscontroller = Get.put(
    Randommealcontroller(),
  );
  @override
  void initState() {
    super.initState();
    foodDetailscontroller.getfooddetaildata();
  }
